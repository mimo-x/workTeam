...
const api: CodexDesktopApi = {
  ...
  listThreads: (options) => ipcRenderer.invoke("codex:list-threads", options),
  readThread: (options) => ipcRenderer.invoke("codex:read-thread", options),
  resumeThread: (options) => ipcRenderer.invoke("codex:resume-thread", options),
  renameThread: (options) => ipcRenderer.invoke("codex:rename-thread", options),
  archiveThread: (options) => ipcRenderer.invoke("codex:archive-thread", options),
  deleteThread: (options) => ipcRenderer.invoke("codex:delete-thread", options),
  forkThread: (options) => ipcRenderer.invoke("codex:fork-thread", options),
  compactThread: (options) => ipcRenderer.invoke("codex:compact-thread", options),
  listSkills: (options) => ipcRenderer.invoke("codex:list-skills", options),
  listMcpServers: (options) => ipcRenderer.invoke("codex:list-mcp-servers", options),
  createWorktree: (options) => ipcRenderer.invoke("codex:create-worktree", options),
  removeWorktree: (options) => ipcRenderer.invoke("codex:remove-worktree", options),
  pickAttachments: (options) => ipcRenderer.invoke("codex:pick-attachments", options),
  discardAttachment: (options) => ipcRenderer.invoke("codex:discard-attachment", options),
