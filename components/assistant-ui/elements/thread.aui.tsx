...
export const Thread: FC<ThreadProps> = ({
  badge = "CX",
  welcome = "想让 Codex 帮你做什么？",
  description = "直接连接电脑上的 Codex，在当前项目中分析、修改和运行代码。",
      ...
      >
        ...
        >
          <AuiIf condition={isNewChatView}>
            <ThreadWelcome badge={badge} welcome={welcome} description={description} />
          </AuiIf>
...
const ThreadWelcome: FC<Pick<ThreadProps, "badge" | "welcome" | "description">> = ({
  badge,
  welcome,
  description,
}) => {
